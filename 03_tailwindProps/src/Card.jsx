...
function Card({content,btnText="Visit me"}) {
console.log(content);
console.log(btnText);
      ...
      <div className="bg-black sm:p-8 p-6 rounded-xl relative overflow-hidden">
        <div className="relative z-10">
          ...
          <div className="flex items-center justify-between">
            ...
            <button className="px-4 py-2 bg-white hover:bg-gray-200 text-white text-sm rounded-lg transition-all duration-200 transform hover:scale-105">
              {btnText}
            </button>
          </div>
        </div>
